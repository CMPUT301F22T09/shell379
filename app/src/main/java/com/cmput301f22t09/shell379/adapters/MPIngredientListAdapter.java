 ...
 */
public class MPIngredientListAdapter extends RecyclerView.Adapter<MPIngredientListAdapter.MPIngredientListViewHolder> {
     ...
     */
    public class MPIngredientListViewHolder extends RecyclerView.ViewHolder {

        TextView description;
        TextView amount;
        TextView category;

        public MPIngredientListViewHolder(@NonNull View itemView) {
            super(itemView);
    ...
    public MPIngredientListAdapter(ArrayList<IngredientStub> recipeIngredients, RecipeIngredientListListener recipeIngredientListListener, EditRecipeViewModel editRecipeViewModel) {
    ...
    @NonNull
    @Override
    public MPIngredientListViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recipe_ingredients_list_content_23, parent, false);
        MPIngredientListViewHolder rsiViewHolder = new MPIngredientListViewHolder(view);
        return rsiViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull MPIngredientListViewHolder holder, int position) {
